...
# ¿Has visto a un chango? ¿Tiene algún parecido contigo? La herencia en programación 
# es muy similar a la herencia en la realidad.

# La herencia es un de las características más importantes de los lenguajes orientados
#  a objetos. Ayuda a no repetir código (DRY). Cuando tienes clases semejantes te
#   permite compartir propiedades y comportamiento basado en una relación jerárquica.
...
# Actividades
# Fíjate en las siguientes clases, trata de relacionarlas y crea los métodos para hacer 
# pasar el driver code. Pon antención en el método que te pedimos en la clase 'Vehicle' 
