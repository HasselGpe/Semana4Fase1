...
# Un objeto se compone de información y de métodos. Depende de como diseñes el objeto, si estos
...
# Este ejercicio te ayudará a comprender como es que un objeto hace pública o privada ya sea información 
# o métodos.
...
# salary
# deposit_account
# ¿Cuales de estas variables deben de tener un reader o writer? Piensa cual de estas variables deberán poder 
# ser leídas o sobrescritas desde fuera de tu programa.
...
# El método to_s es el símil del método toString de otros lenguajes de programación. Este método 
# se utiliza para que nos devuelva una cadena de texto, que suele ser la información más relevante del 
# objeto. Si haces una clase Dog vacía y llamas puts en una de sus instancias regresará 
# #<Dog:0x007ffd389b7930>. Tu puedes re-definir este método y en nuestro caso, deberá regresar una
#  representación gráfica de nuestro empleado. Cuando digo re-definir me refiero a que por default 
#  todas las clases ya lo tienen, ya que heredan de la clase object (si aún no has visto que quiere 
#   decir que una clase hereda de otra, ya lo aprenderás no te preocupes).

# Que métodos deben ser públicos?
# De los siguientes tres métodos decide cual de ellos solamente tiene sentido que se conozca internamente
#  y cuales deben de ser públicos.
